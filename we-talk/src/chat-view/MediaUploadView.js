        ...
        <>
            ...
            <div className="btn-group-vertical" id='media_upload_view'
                ...
                <button id='img_upload' type="button" className="btn btn-outline-primary"
                    style={{ background: '#6cc4ea', borderColor: '#FFFFFF', margin: '10px', borderRadius: '15px 50px 30px' }}
                    onClick={() => chooseFile('upload_image_textfield')}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFFFFF" className="bi bi-card-image" viewBox="0 0 16 16">
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFFFFF" className="bi bi-camera-video" viewBox="0 0 16 16">
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#FFFFFF" className="bi bi-mic" viewBox="0 0 16 16">
