...
function MainView({ selfInfo, activeContact, setActiveContact }) {
    ...
    return (
        <div className='row g-0' style={{ maxHeight: '90vh', height: '90vh', width: '90vw', minWidth: '700px', background: '#f0f3f9' }}>
            <div className='col-lg-4' style={{width: '26%', minWidth:'300px', padding: '0px', background:'white' }}>
