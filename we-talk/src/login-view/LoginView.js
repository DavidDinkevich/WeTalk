                                ...
                                <form novalidate className="px-4 py-3" style={{ float: 'center' }}>
                                    <div className="mb-3">
                                        <div className="input-group has-validation">
                                            <input type="text" className="form-control" placeholder="Username" id="validationCustomUsername" aria-describedby="inputGroupPrepend" required style={{ lineHeight: '3' }} pattern="^([a-zA-Z@*#]{1,8})$" title="name must be only with characters." />
